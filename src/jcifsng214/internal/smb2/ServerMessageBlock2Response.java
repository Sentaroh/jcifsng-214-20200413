...
import jcifsng214.smb.NtStatus;
...
public abstract class ServerMessageBlock2Response extends ServerMessageBlock2 implements CommonServerMessageBlockResponse {
     ...
     * {@inheritDoc}
     *
     * @see jcifsng214.internal.smb2.ServerMessageBlock2#reset()
     */
    @Override
    public void reset () {
        super.reset();
     ...
     * {@inheritDoc}
     *
     * @see jcifsng214.util.transport.Response#clearReceived()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng214.util.transport.Response#isReceived()
     */
    @Override
     ...
     *
     * @see jcifsng214.internal.smb2.ServerMessageBlock2#haveResponse(byte[], int, int)
     */
    @Override
