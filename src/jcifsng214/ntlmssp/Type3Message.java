...
import jcifsng214.ntlmssp.av.AvFlags;
import jcifsng214.ntlmssp.av.AvPair;
import jcifsng214.ntlmssp.av.AvPairs;
import jcifsng214.ntlmssp.av.AvSingleHost;
import jcifsng214.ntlmssp.av.AvTargetName;
import jcifsng214.ntlmssp.av.AvTimestamp;
import jcifsng214.smb.NtlmUtil;
...
public class Type3Message extends NtlmMessage {
    ...
    public String toString () {
        ...
        return "Type3Message[domain=" + domainString + ",user=" + userString + ",workstation=" + workstationString + ",lmResponse="
                ...
                + jcifsng214.util.Hexdump.toHexString(getFlags(), 8) + "]";
    }
