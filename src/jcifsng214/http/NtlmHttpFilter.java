...
import jcifsng214.Config;
import jcifsng214.config.PropertyConfiguration;
import jcifsng214.context.BaseContext;
import jcifsng214.netbios.UniAddress;
import jcifsng214.smb.NtStatus;
import jcifsng214.smb.NtlmChallenge;
import jcifsng214.smb.NtlmPasswordAuthentication;
import jcifsng214.smb.SmbAuthException;
import jcifsng214.smb.SmbException;
import jcifsng214.smb.SmbSessionInternal;
    ...
    protected NtlmPasswordAuthentication negotiate ( HttpServletRequest req, HttpServletResponse resp, boolean skipAuthentication )
        ...
        if ( msg != null && ( msg.startsWith("NTLM ") || ( offerBasic && msg.startsWith("Basic ") ) ) ) {
            ...
            try {
                ...
                log.warn("NtlmHttpFilter: " + ntlm.getName() + ": 0x" + jcifsng214.util.Hexdump.toHexString(sae.getNtStatus(), 8) + ": " + sae);
