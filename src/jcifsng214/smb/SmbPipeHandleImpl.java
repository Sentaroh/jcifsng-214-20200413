...
class SmbPipeHandleImpl implements SmbPipeHandleInternal {
     ...
     * {@inheritDoc}
     *
     * @see jcifsng214.SmbPipeHandle#unwrap(java.lang.Class)
     */
     ...
     * {@inheritDoc}
     *
     * @see jcifsng214.SmbPipeHandle#getPipe()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng214.SmbPipeHandle#isOpen()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng214.smb.SmbPipeHandleInternal#getSessionKey()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng214.SmbPipeHandle#isStale()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng214.SmbPipeHandle#getInput()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng214.SmbPipeHandle#getOutput()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng214.smb.SmbPipeHandleInternal#sendrecv(byte[], int, int, byte[], int)
     */
     ...
     * {@inheritDoc}
     *
     * @see jcifsng214.smb.SmbPipeHandleInternal#getPipeType()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng214.SmbPipeHandle#close()
     */
    @Override
