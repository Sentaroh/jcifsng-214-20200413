...
import jcifsng214.spnego.NegTokenInit;
...
class Kerb5Context implements SSPContext {
     ...
     * {@inheritDoc}
     *
     * @see jcifsng214.smb.SSPContext#isSupported(org.bouncycastle.asn1.ASN1ObjectIdentifier)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng214.smb.SSPContext#isPreferredMech(org.bouncycastle.asn1.ASN1ObjectIdentifier)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng214.smb.SSPContext#getSupportedMechs()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng214.smb.SSPContext#getFlags()
     */
    @Override
    public int getFlags () {
        int contextFlags = 0;
     ...
     * {@inheritDoc}
     *
     * @see jcifsng214.smb.SSPContext#supportsIntegrity()
     */
    @Override
     ...
     *
     * @see jcifsng214.smb.SSPContext#calculateMIC(byte[])
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng214.smb.SSPContext#verifyMIC(byte[], byte[])
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng214.smb.SSPContext#isMICAvailable()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng214.smb.SSPContext#getNetbiosName()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng214.smb.SSPContext#getSigningKey()
     */
    @Override
